...
# Windows-specific compiler and linker settings
...
if(DEV_MODE)
  ...
  if(EXISTS "${CMAKE_SOURCE_DIR}/src-react/dist/index.html" OR EXISTS "${CMAKE_SOURCE_DIR}/src-react/dist/dist.zip")
    if(NOT EXISTS "${CMAKE_SOURCE_DIR}/res/resource_init.cpp" OR
      ...
      execute_process(
        COMMAND ${CMAKE_SOURCE_DIR}/scripts/platforms/windows/membrane_resource_compiler.exe
...
if(EXISTS "${CMAKE_SOURCE_DIR}/res/app.ico")
  configure_file(
    "${CMAKE_CURRENT_SOURCE_DIR}/scripts/platforms/windows/resource.rc.in"
    "${CMAKE_BINARY_DIR}/resource.rc"
    @ONLY
  )
  target_sources(${BINARY_NAME} PRIVATE "${CMAKE_BINARY_DIR}/resource.rc")
endif()
